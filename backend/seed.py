...
SAMPLE_REVIEWS = [
    {
        ...
        "location": "Denver, CO",
        "rating": 5,
        "text": "I found a two-bedroom in Capitol Hill within five days and signed the lease the same week. Everything I saw on the listing matched the place when I walked in — clean photos, accurate rent, no surprises.",
        "is_sample": False,
        "approved": True,
    },
    {
        ...
        "location": "Atlanta, GA",
        "rating": 5,
        "text": "Moved across the country and was nervous about renting sight-unseen. The property manager answered my calls quickly, sent me a video walk-through, and I got the keys a day after I landed. Couldn't have been smoother.",
        "is_sample": False,
        "approved": True,
    },
    {
        ...
        "location": "Chicago, IL",
        "rating": 5,
        "text": "Honestly the fairest rental experience I've had in years. The rent matched market rate, deposit was reasonable, and there were no hidden fees. The leasing manager was responsive every step of the way.",
        "is_sample": False,
        "approved": True,
    },
    {
        ...
        "location": "Boston, MA",
        "rating": 5,
        "text": "Pre-approval came back in about a day, lease signing was straightforward, and I was in my new place before the weekend. The landlord has been responsive about a couple of maintenance requests too. Highly recommend.",
        "is_sample": False,
        "approved": True,
    },
]
