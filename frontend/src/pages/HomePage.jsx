      ...
      <section className="rs-section" data-testid="reviews-section">
        <div className="rs-container">
          <div className="max-w-2xl mb-10">
            ...
            <h2 className="font-display text-3xl sm:text-4xl font-bold text-[#0A192F] mb-4">Trusted by renters across the country</h2>
            <p className="text-sm text-slate-500">Read what verified applicants have to say about the RentSure Homes experience.</p>
          </div>
